...
%% page of your paper.
%%
%% With the ``\copyrightspace'' command uncommented, as shown below, space
%% WILL be left blank for the copyright information. 
%% If your contribution does not require a copyright space (poster, talk,
%% sketch or other abstract), you may comment the command out or delete it.
